...
function getRandomNumbers (min, max){
    ...
    console.log('nums pc 2: ' + randomNumbers);
...
function pointsCounter(slotTentativi, numeriComputer, max, difficoltaWord) {
    ...
    continuaInserimento = true;
    console.log('nums pc fuori listener: ' + numeriComputer);
    ...
    if (cont <= 1) {
        ...
        btnCalcola.addEventListener('click', function(){
            console.log('nums pc 3: ' + numeriComputer);
            console.log('LISTENER CALCOLA' , continuaInserimento);
            ...
            if (continuaInserimento) {
                ...
                // Altrimenti quando abbiamo un inserimento corretto
                    ...
                    console.log('NUMERI PC 4 ' + numeriComputer);
                    ...
                    // Se arrivo alla fine dei tentativi ho vinto
                        ...
                        for (let i = 0; i < 16; i++) {
                            ...
                            listaNumPC.children[i].style.margin = '10px 20px';
                            window.scrollTo({ top: document.body.scrollHeight, behavior: 'smooth' });
                            console.log('LISTA NUM PC: ' + listaNumPC);
                        }
...
function campoMinato() {
    ...
    // console.log('nums pc 1: ' + numeriComputer);
    var numeriComputer = getRandomNumbers(min, max);
    console.log('Numeri Computer 1.2: ' + numeriComputer);
